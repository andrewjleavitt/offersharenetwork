...
class NamesControllerTest < ActionController::TestCase
  ...
  test "should create name" do
    assert_difference('Name.count') do
      post :create, name: { active: @name.active, description: @name.description, logo_url: @name.logo_url }
    end
  ...
  test "should update name" do
    patch :update, id: @name, name: { active: @name.active, description: @name.description, logo_url: @name.logo_url }
    assert_redirected_to name_path(assigns(:name))
  end
