...
class PaymentPlansControllerTest < ActionController::TestCase
  ...
  test "should create payment_plan" do
    assert_difference('PaymentPlan.count') do
      post :create, payment_plan: { amount: @payment_plan.amount, billing_period: @payment_plan.billing_period, description: @payment_plan.description, name: @payment_plan.name, stripe_id: @payment_plan.stripe_id }
    end
  ...
  test "should update payment_plan" do
    patch :update, id: @payment_plan, payment_plan: { amount: @payment_plan.amount, billing_period: @payment_plan.billing_period, description: @payment_plan.description, name: @payment_plan.name, stripe_id: @payment_plan.stripe_id }
    assert_redirected_to payment_plan_path(assigns(:payment_plan))
  end
